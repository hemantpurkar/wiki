	...
	tinymce.create('tinymce.plugins.ExamplePlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceExample', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm',
					width : 320 + parseInt(ed.getLang('chart.delta_width', 0)),
					height : 120 + parseInt(ed.getLang('chart.delta_height', 0)),
					inline : 1
				}, {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxiecode.com/index.php/TinyMCE:Plugins/chart',
				version : "1.0"
			};
		}
	});
